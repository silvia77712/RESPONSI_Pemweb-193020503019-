...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <a class="btn btn-primary btn-lg" href="AdminPage.php">Kembali</a>
        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              <a class="btn btn-primary btn-lg" href="daftarTrx.php">Detail Transaksi</a>
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    <th><i class="icon_profile"></i> id_user</th>
                    ...
                    <th><i class="icon_mail_alt"></i> Update</th>
                    
                  </tr>
                  <?php
                    require('../koneksi.php');
                    $sql  = "SELECT * FROM pernota";
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="updateStatusTrx.php?proses=&kode=<?php echo $data["kode"]; ?>" onclick="return confirm('pesanan diproses');">diproses</a>
                        <a class="btn btn-danger" href="updateStatusTrx.php?selesai=&kode=<?php echo $data["kode"]; ?>" onclick="return confirm('pesanan telah selesai');">selesai</a>
                        </div>
                    </td>
